...
import com.htt.billing.coverage.CoverageRepository.Coverage
import com.htt.billing.coverage.PayerRepository.Payer
import com.htt.billing.coverage.dto.CoverageBody
import com.htt.billing.patient.PatientRepository
import com.htt.billing.patient.PatientRepository.Patient
 ...
 *
 * Out-of-scope reads answer "not found", the same as in [com.htt.billing.patient.PatientService].
 */
@Service
