package com.htt.billing.service.claim

import com.htt.billing.adjudication.PayerSimulator
import com.htt.billing.api.claim.ClaimBody
...
import com.htt.billing.repository.claim.ClaimRepository.ClaimSummary
...
class ClaimService(
    ...
    private fun parseLines(rows: List<com.htt.billing.api.claim.LineBody>): List<LineInput> =
