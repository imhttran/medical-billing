...
object Api {
     ...
     * [label] names what failed to parse, so a bad patient id does not report
     * itself as a user id.
     */
    fun parseId(raw: String, label: String = "id"): Int =
        raw.toIntOrNull() ?: throw ApiRejection(HttpStatus.BAD_REQUEST, msg("Invalid $label"))
